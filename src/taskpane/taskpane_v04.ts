...
function populateTitleListBox() {
  const titleListBox = document.getElementById("titleListBox") as HTMLSelectElement;
  const titleSearch = document.getElementById("titleSearch") as HTMLInputElement;
  ...
  function updateTitleListBox(searchText = "") {
    ...
    filteredTemplates
      .filter(template => template.title.toLowerCase().includes(searchText.toLowerCase()))
      .forEach(template => {
        let option = document.createElement("option");
...
function insertTemplate() {
  ...
  const titleSearch = document.getElementById("titleSearch") as HTMLInputElement;
  const clearSearchBtn = document.getElementById("clearSearchBtn") as HTMLButtonElement;
  const insertButton = document.getElementById("insertTemplateBtn") as HTMLButtonElement;
